...
class BaseConfig:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--gcn_model', type=str, default='gcn', choices=['gcn', 'gat','graphsage','gin'])
        self.parser.add_argument('--gcn_layers', type=int, default=4)
        self.parser.add_argument('--n_hidden', type=int, default=40,
        ...
        self.parser.add_argument('--nb_epochs_gcn', type=int, default=15)
