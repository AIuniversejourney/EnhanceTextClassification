...
from model import BertGCN,BertGraphSAGE
from \
    utils import *
...
if __name__ == '__main__':
    ...
    elif ARGS.gcn_model == 'graphsage':
        MODEL = BertGraphSAGE(nb_class=NB_CLASS, pretrained_model="C:/Users/AGM1/F.Gh/New/bert1", m=ARGS.m,
                        gcn_layers=ARGS.gcn_layers,
                        n_hidden=ARGS.n_hidden, dropout=ARGS.dropout)
    else:
