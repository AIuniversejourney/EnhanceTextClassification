...
if __name__ == '__main__':
    ...
    DIGI_DATASET = pandas.read_excel("C:/Users/AGM1/F.Gh/Arabic/Arabic-twitter-corpus-AJGT-master/AJGT.xlsx")

    DIGI_DATASET = pandas.DataFrame({'comment': list(DIGI_DATASET['Feed']),
                                     'recommend': list(DIGI_DATASET['Sentiment'])})
